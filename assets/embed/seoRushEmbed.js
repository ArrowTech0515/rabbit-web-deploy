...
let r = "https://seorush.me/";
console.log("apiUrl is " + r);
var t = {
    o: "", id: "", type: "", t: "", i: 0, l: {g: 2, p: 3}, u: function (o) {
        return o = o.replace(/^#/, ""), {
            red: parseInt(o.substring(0, 2), 16),
            green: parseInt(o.substring(2, 4), 16),
            blue: parseInt(o.substring(4, 6), 16)
        }
    }, v: function (o) {
        var o = new Date(o), e = o.getDate(), t = o.getFullYear();
        return e + (e % 10 == 1 && 11 !== e ? "st" : e % 10 == 2 && 12 !== e ? "nd" : e % 10 == 3 && 13 !== e ? "rd" : "th") + ` ${["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][o.getMonth()]}, ` + t
    }, h: function (data) {
        var data = data.split("-"), type = "", o = parseInt(data[1]);
        return this.type = data[0], [type = "Template" == data[0] ? "template" : type, o]
    }, m: function () {
        return `
    ...
    }, k: function (type, id, data, index) {
        var o = "", element = ".blog-card-container", e = !1;
        return "template" == type && (1 == id ? o = `
                ...
                `)), {element: element, body: o, C: e}
    }, F: function (type, id, data, index) {
        var o = "", element = "";
        return "template" == type && (1 == id || 2 == id ? o = `
        ...
        var e = this, t = {}, a = {color: "#000000", size: 1, opacity: 0};
        $.each(data.is, function (index, o) {
            t[o.name] = o.value, e.update(o.name, o.value)
        }), $.each(data.textfields, function (index, o) {
            e.update(o.name, o.value, t)
        }), $.each(data.fonts, function (index, o) {
            e.update(o.name, o.value, t)
        }), $.each(data.colors, function (index, o) {
            "shadowColor" == o.name && (a.color = o.value), e.update(o.name, o.value, t)
        }), $.each(data.sliders, function (index, o) {
            "shadowSize" == o.name ? a.size = o.value : "shadowOpacity" == o.name && (a.opacity = o.value), e.update(o.name, o.value, t)
        }), e.update("coverImage", data.image.cover, t), e.update("backgroundImage", data.image.background, t), null != data.touch.icon && e.update("touchIcon", data.touch.icon, t), null != data.touch.position && e.update("touchPosition", data.touch.position, t), e.update("synonym", data.synonym, t), null != data.post && "" != data.post.layout && e.S(data.post.layout), e.update("shadow", a, t)
    }, D: function (e) {
        var t = this, o = {};
        o.L = userId[this.o], o.o = this.o, $.ajax({
            url: r + "getMyJsonUserBlogGuest",
            dataType: "json",
            async: !0,
            type: "POST",
            data: o,
            success: function (o) {
                console.log("getMyJsonUserBlogGuest result " + JSON.stringify(o)), o.list && t.I(o.list, e)
            }
        })
    }, B: function (o, e) {
        var t = this, a = {};
        a.L = userId[this.o], a.o = this.o, a.O = o, $.ajax({
            url: r + "getMyJsonUserBlogPostGuest",
            dataType: "json",
            async: !0,
            type: "POST",
            data: a,
            success: function (o) {
                console.log("getMyJsonUserBlogPostGuest result " + JSON.stringify(o)), o.obj && t._(o.obj, e)
            }
        })
    }, _: function (data, o) {
        $(".blog-article-container .article-blog-area h1").text(data.title), $(".blog-article-container .article-blog-area p").html(data.text), $(".blog-article-container .article-blog-area .date").text(this.v(new Date(data.dateCreated.time).toISOString())), $(".blog-article-container .article-blog-area .likes-info span").html('<i class="bi bi-heart"></i>' + data.wordsCount), o ? $(".blog-article-container").removeClass("opacity-0") : $(".blog-article-container").fadeIn(), setTimeout(function () {
            $(".blog-article-container .background-container").css("height", $(".blog-article-container .article-wrapper").height() + 64 + "px")
        }, 100)
    }, I: function (o, e) {
        var t = this, a = -1, r = "", i = "";
        $.each(o, function (index, post) {
            var o = t.k(t.t, t.i, post, index), post = t.F(t.t, t.i, post, index);
            "" != o.element && (o.C ? (++a % 2 == 0 && (i += '<div class="row">'), r = o.element, i += o.body, a % 2 == 1 && (i += "</div>")) : $(".plugin-widget-container " + o.element).append(o.body)), "" != post.element && $(".plugin-widget-container " + post.element).append(post.body)
        }), 0 < a && (a % 2 == 1 && (i += "</div>"), $(".plugin-widget-container " + r).append(i)), t.A(e), $(".btnTouch").on("click", function (o) {
            o.preventDefault(), $(".plugin-widget-container").fadeIn(), $("#preview_widget").addClass("overlay"), setTimeout(function () {
        ...
        }), $(".plugin-widget-container").on("click", ".blog-card .read-more-btn", function (o) {
            o.preventDefault(), t.B($(this).closest(".blog-card").attr("data-id"), $(this).closest(".plugin-widget-container").hasClass("has-blog-article"))
        }), $(".plugin-widget-container").on("click", ".blog-card.has-action", function (o) {
            o.preventDefault(), t.B($(this).attr("data-id"), $(this).closest(".plugin-widget-container").hasClass("has-blog-article"))
        }), $(".blog-article-container").on("click", ".close_btn", function (o) {
            o.preventDefault(), $(".blog-article-container").fadeOut()
        })
    }, init: function (data, o) {
        var e = this, t = (e.id = data[0], this.h(data[2])), a = this.T(t[0], t[1]),
            t = (e.t = t[0], e.i = t[1], JSON.parse(data[4])),
            data = (console.log("blog template------------", data, t, o), $("#preview_widget").html(""), $(`<button class="btnTouch"><span class="icon"><i class="bi ${t.touch.icon}"></i></span> <span class="text"></span></button>`));
        $("#preview_widget").append(data), $("#preview_widget").append(a), 0 < $(".plugin-widget-container.has-blog-article").length || (o = this.m(), $("#preview_widget").append(o)), e.A(t), e.D(t)
    }
};
realSite && (loadCss("assets/css/bootstrap.min.css"), loadCss("assets/css/bootstrap-icons.min.css"), loadCss("assets/css/seoRush.css"), t.o = getAppGuid(), $("body").prepend('<div id="preview_widget"></div>'), null != widgets[t.o]) && 0 < widgets[t.o].length && t.init(widgets[t.o][0], addPoweredBy[t.o]);