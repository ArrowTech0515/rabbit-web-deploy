var SignupLandEmbeddedObject={guid:"",o:!1,id:0,type:"",plugin:"",t:0,i:0,l:function(data){var data=data.split("-"),type="",o=parseInt(data[1]);return this.type=data[0],"Contact_Us"==data[0]?type="contact_forms":"Join_Newsletter"==data[0]?type="join_newsletter":"Lead_Generation"==data[0]&&(type="lead_generation"),[type,o]},p:function(o){return o=o.replace(/^#/,""),{red:parseInt(o.substring(0,2),16),green:parseInt(o.substring(2,4),16),blue:parseInt(o.substring(4,6),16)}},u:function(type,o){if("contact_forms"==type){if(1==o)return`
