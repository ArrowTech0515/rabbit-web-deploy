var SignupLandEmbeddedObject={guid:"",o:!1,t:!1,id:0,type:"",plugin:"",i:0,l:!1,p:0,g:0,u:function(data){var data=data.split("-"),type="",o=parseInt(data[1]);return this.type=data[0],"Contact_Us"==data[0]?type="contact_forms":"Join_Newsletter"==data[0]?type="join_newsletter":"Lead_Generation"==data[0]?type="lead_generation":"Support_Ticket"==data[0]?type="support_ticket":"Leave_Comment"==data[0]?type="leave_comment":"Request_Quote"==data[0]&&(type="request_quote"),[type,o]},v:function(o){return o=o.replace(/^#/,""),{red:parseInt(o.substring(0,2),16),green:parseInt(o.substring(2,4),16),blue:parseInt(o.substring(4,6),16)}},m:function(type,o){if("contact_forms"==type){if(1==o)return`
                ...
                `;return'<div class="col-md-12 plugin-widget-container">'},h:function(o,color){color=`
