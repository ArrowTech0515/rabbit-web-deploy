                            ...
                            <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12 form-wrapper for-backgroundColor">
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        ...
                                        <p class="description for-sizeHeightMarginBottom for-bodyTextColor for-secondaryFont">If you have any questions or want to know more about our service, contact us using the contact form below</p>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12 form-wrapper for-backgroundColor">
                                ...
                                <div class="contact-form">
                                    ...
                                    <p class="for-sizeHeightMarginBottom for-bodyTextColor for-secondaryFont">If you have any questions or want to know more about our service, contact us using the contact form below</p>
                                    <form class="form-container" method="post">
                                        <div class="form-group-list">
                                            <div class="form-group">
