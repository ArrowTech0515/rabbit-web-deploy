var r="",o={o:!1,t:!1,id:0,type:"",i:"",plugin:"",l:0,g:!1,p:0,u:0,m:function(data){var data=data.split("-"),type="",o=parseInt(data[1]);return this.type=data[0],"Contact_Us"==data[0]?type="contact_forms":"Join_Newsletter"==data[0]?type="join_newsletter":"Lead_Generation"==data[0]?type="lead_generation":"Support_Ticket"==data[0]?type="support_ticket":"Leave_Comment"==data[0]?type="leave_comment":"Request_Quote"==data[0]&&(type="request_quote"),[type,o]},v:function(o){return o=o.replace(/^#/,""),{red:parseInt(o.substring(0,2),16),green:parseInt(o.substring(2,4),16),blue:parseInt(o.substring(4,6),16)}},h:function(){return $(window).width()<999},C:function(type,o){var t=this.id;if("contact_forms"==type){if(1==o)return`
                                                    ...
                                                    <form class="form-container " method="post">
                                                        ...
                                                        <div class="form-custom-wrapper for-sizeHeightMarginBottom">
                                                            <div class="form-group for-sideSpacingMarginRight">
                                                                <input class="form-control for-fieldTextColor for-fieldFont mw-250" type="text" name="Email" placeholder="Enter your Email">
                                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-8 col-lg-10 col-md-12 form-wrapper for-controlBorderBottomOnly">
                                            ...
                                            <div class="row position-relative for-sizeHeightMarginTop for-sizeHeightMarginBottom p-5">
                                                ...
                                                <div class="col-lg-6 mobile-pt-5">
                ...
                `}return`<div class="col-md-12 plugin-widget-container" data-id="${t}">`},T:function(o,color,t){var i=this,background="#F5576C",background="contact_forms"==i.i&&3==i.widgetID?"#C493F3":"lead_generation"==i.i&&1==i.widgetID?"#F5576C":"lead_generation"==i.i&&4==i.widgetID?"#F1EA7C":"join_newsletter"==i.i&&3==i.widgetID?"#f6d365":"leave_comment"==i.i&&1==i.widgetID?"#0C41D2":t,t=`
