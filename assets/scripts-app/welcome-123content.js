$(document.head).append('<link rel="icon" type="image/x-icon" href="/assets/home123/favicon.ico">');
...
function isDev() { 
    return location.toString().toLowerCase().includes("c:/") || location.toString().toLowerCase().includes("d:/") || location.toString().toLowerCase().includes("rabbitweb.test/") || location.toString().toLowerCase().includes("aptest.therssoftware.com");
}
...
$(document).ready(function () {
    if (isDev()) {
        ...
        apiUrl = 'https://www.123content.net/';
        drawPlans();
    } else {
        initPlans();
    }
